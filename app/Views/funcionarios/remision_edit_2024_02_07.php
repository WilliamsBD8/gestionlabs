                        ...
                        <form action="<?= base_url(['funcionario','remisiones','muestra']) ?>" method="POST" id="frm_form_muestra" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="input-field col l4 s12 condiciones">
                                    <select id="frm_condiciones_recibido" name="frm_condiciones_recibido" class="validate">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col l6 s12 mue_procedencia">
                                    ...
                                    <label>Muestra recolectada por</label>
                                </div>
                            </div>
                            <div class="row finish">
                                ...
                                <div class="input-field col l8 s12 frm_producto">
                                    <select class="select2 browser-default" onchange="muestra_producto(this.value, 4)" id="frm_producto" name="frm_producto" disabled="true">
